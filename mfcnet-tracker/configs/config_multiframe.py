...
def train_config_parser(parser):
    ...
    parser.add_argument('--data_dir', type=str, default='/data/home/hao/chenyan/data/reconstruction_by_action', 
                        help='Path to data directory. Default: /data/home/hao/chenyan/data/reconstruction_by_action')
    ...
    parser.add_argument('--action', type=str, default='dissect', choices=['grasp', 'clip','dissect', 'cut'], 
                        help='Mode of operation. Default: dissect')
    ...
    parser.add_argument('--expt_name', type=str, default='multiframe_segmentation_expt_kpt_dissect_final',
                        help='Experiment name. Default: multiframe_segmentation_expt_kpt_dissect_final')
...
def test_config_parser(parser):
    ...
    # I/O related arguments
    parser.add_argument('--expt_savedir', type=str, default='/data/home/hao/chenyan/checkpoint/testing_multiframe', 
                        help='Path to save experiment results. Default: /data/home/hao/chenyan/checkpoint/testing_multiframe')
    ...
    parser.add_argument('--load_wts_base_model', type=str, default= None,
                        help='Path to base model weights from a pretrained per-frame model. Default: None')
    parser.add_argument('--load_wts_model', type=str, default='/data/home/hao/chenyan/checkpoint/multiframe_segmentation_expt_kpt_dissect_full_full/ckpts/model_010.pth', 
                        help='Path to model weights. Default: None')
    parser.add_argument('--input_height', type=int, default=256, help='NN input image height')
    parser.add_argument('--input_width', type=int, default=320, help='NN input image width')
    parser.add_argument('--add_optflow_inputs', type=bool, default=False, help='Add optical flow inputs')
